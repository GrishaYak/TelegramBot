...
from alterations.checkout_alteration import checkout_alteration, checkout_alteration2
...
checkout_alteration_handler = CommandHandler("checkout_alterations", checkout_alteration)
checkout_alteration_handler2 = MessageHandler(filters.TEXT & ~filters.COMMAND, checkout_alteration2)

delete_user_are_you_shure_handler = CommandHandler("delete_me", delete_user)
delete_user_handler = MessageHandler(filters.TEXT & ~filters.COMMAND, delete_user2)
